...
function buildFigmaPluginScript(ds: DesignSystem): string {
  ...
  const body = [
    ...
    "    cy += btnSet.height + 56;",
    "  } catch(e) { console.warn('Button set failed:', e); cy += 120; }",
    "}",
    "",
    "// ── Components: Badges ────────────────────────────────────────────────────",
    ...
    "  } catch(e) { console.warn('Badge set failed:', e); cy += 60; }",
    "}",
    "",
    "// ── Components: Alerts ────────────────────────────────────────────────────",
    ...
    "  alc.primaryAxisSizingMode = 'AUTO';",
    ...
    "  albody.fills = [{type:'SOLID',color:al.text,opacity:0.85}];",
    ...
    "  } catch(e) { console.warn('Alert set failed:', e); cy += 80; }",
    "}",
    "",
