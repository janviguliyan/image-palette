...
function buildDS(ds: DesignSystem, primaryFont = "Inter", secondaryFont = "Roboto") {
  ...
  const buttons = [
    // No icon (all types × LG + SM × 3 states)
    B("Type=Primary, Size=LG, Icon=None, State=Default",    pRgb,    pTextRgb, null,     18, 10, 13, false),
    B("Type=Primary, Size=LG, Icon=None, State=Hover",      p600Rgb, pTextRgb, null,     18, 10, 13, false),
    B("Type=Primary, Size=LG, Icon=None, State=Disabled",   pRgb,    pTextRgb, null,     18, 10, 13, true ),
    B("Type=Primary, Size=SM, Icon=None, State=Default",    pRgb,    pTextRgb, null,     12,  6, 11, false),
    B("Type=Primary, Size=SM, Icon=None, State=Hover",      p600Rgb, pTextRgb, null,     12,  6, 11, false),
    B("Type=Primary, Size=SM, Icon=None, State=Disabled",   pRgb,    pTextRgb, null,     12,  6, 11, true ),
    B("Type=Secondary, Size=LG, Icon=None, State=Default",  p50Rgb,  p700Rgb,  p200Rgb,  18, 10, 13, false),
    B("Type=Secondary, Size=LG, Icon=None, State=Hover",    p100Rgb, p700Rgb,  pRgb,     18, 10, 13, false),
    B("Type=Secondary, Size=LG, Icon=None, State=Disabled", p50Rgb,  p700Rgb,  p200Rgb,  18, 10, 13, true ),
    B("Type=Secondary, Size=SM, Icon=None, State=Default",  p50Rgb,  p700Rgb,  p200Rgb,  12,  6, 11, false),
    B("Type=Secondary, Size=SM, Icon=None, State=Hover",    p100Rgb, p700Rgb,  pRgb,     12,  6, 11, false),
    B("Type=Secondary, Size=SM, Icon=None, State=Disabled", p50Rgb,  p700Rgb,  p200Rgb,  12,  6, 11, true ),
    B("Type=Ghost, Size=LG, Icon=None, State=Default",      null,    p700Rgb,  p200Rgb,  18, 10, 13, false),
    B("Type=Ghost, Size=LG, Icon=None, State=Hover",        p50Rgb,  p700Rgb,  pRgb,     18, 10, 13, false),
    B("Type=Ghost, Size=LG, Icon=None, State=Disabled",     null,    p700Rgb,  p200Rgb,  18, 10, 13, true ),
    B("Type=Ghost, Size=SM, Icon=None, State=Default",      null,    p700Rgb,  p200Rgb,  12,  6, 11, false),
    B("Type=Ghost, Size=SM, Icon=None, State=Hover",        p50Rgb,  p700Rgb,  pRgb,     12,  6, 11, false),
    B("Type=Ghost, Size=SM, Icon=None, State=Disabled",     null,    p700Rgb,  p200Rgb,  12,  6, 11, true ),
    B("Type=Danger, Size=LG, Icon=None, State=Default",     eRgb,    eTextRgb, null,     18, 10, 13, false),
    B("Type=Danger, Size=LG, Icon=None, State=Hover",       e600Rgb, eTextRgb, null,     18, 10, 13, false),
    B("Type=Danger, Size=LG, Icon=None, State=Disabled",    eRgb,    eTextRgb, null,     18, 10, 13, true ),
    B("Type=Danger, Size=SM, Icon=None, State=Default",     eRgb,    eTextRgb, null,     12,  6, 11, false),
    B("Type=Danger, Size=SM, Icon=None, State=Hover",       e600Rgb, eTextRgb, null,     12,  6, 11, false),
    B("Type=Danger, Size=SM, Icon=None, State=Disabled",    eRgb,    eTextRgb, null,     12,  6, 11, true ),
    // Icon=Left variants (LG only — no extra spaces in names)
...
export function buildFigmaPluginScript(ds: DesignSystem, primaryFont = "Inter", secondaryFont = "Roboto"): string {
  ...
  const body = [
    ...
    "",
    "// ── 2. Load Fonts ─────────────────────────────────────────────────────────",
    "// Guarantee Inter is loaded first (used as fallback everywhere)",
    "var INTER_STYLES = ['Regular','Medium','SemiBold','Bold','ExtraBold','Black'];",
    "for (var isi = 0; isi < INTER_STYLES.length; isi++) {",
    "  try { await figma.loadFontAsync({family:'Inter',style:INTER_STYLES[isi]}); } catch(e) {}",
    "}",
    "var FONTS = DS.fontsToLoad;",
    "var loaded = {};",
    "loaded['Inter/Regular']=1; loaded['Inter/Medium']=1; loaded['Inter/SemiBold']=1; loaded['Inter/Bold']=1;",
    ...
    "}",
    "console.log('Fonts loaded:', Object.keys(loaded).length, '/', FONTS.length+6);",
    "function fn(fam, sty) {",
    ...
    "",
    "// ── Components: Buttons ───────────────────────────────────────────────────",
    "console.log('Starting Buttons section, cy=', cy, 'buttons:', DS.components.buttons.length);",
    "cy += 8;",
    ...
    "  var blabel = (bd.name.match(/Type=([^,]+)/) || [])[1] || 'Btn';",
    "  if (bd.iconLeft) {",
    "    var bico = figma.createText();",
    "    bico.fontName = loaded['Material Icons/Regular'] ? {family:'Material Icons',style:'Regular'} : fn(DS.sFont,'Regular');",
    "    bico.fontSize = 18;",
    "    bico.characters = loaded['Material Icons/Regular'] ? 'chevron_right' : '\u203a';",
    ...
    "    bicor.fontName = loaded['Material Icons/Regular'] ? {family:'Material Icons',style:'Regular'} : fn(DS.sFont,'Regular');",
    "    bicor.fontSize = 18;",
    "    bicor.characters = loaded['Material Icons/Regular'] ? 'chevron_right' : '\u203a';",
