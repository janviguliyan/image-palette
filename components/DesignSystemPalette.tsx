...
const ROLE_LABELS: [keyof Props["roles"], string][] = [
  ["primary", "Primary"],
  ["secondary", "Secondary"],
  ["tertiary", "Tertiary"],
  ["accent", "Accent"],
  ...
  return (
    <button
      ...
      className={`group relative flex-1 flex flex-col items-center justify-end transition-opacity hover:opacity-90 ${
        !isLast ? "border-r border-[#0a0a0a]/10" : ""
      }`}
...
export default function DesignSystemPalette({ scales, roles }: Props) {
