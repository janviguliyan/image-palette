    ...
    <div className="min-h-screen bg-white" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      {hasResult && designSystem && (
        <div>
          ...
          {/* items-start is required so position:sticky on sidebar works inside flex */}
          <div className="flex items-start">

            {/* Sidebar — sticky, measured to sit flush below header */}
            <DesignSystemSidebar
              primaryColor={designSystem.roles.primary}
              onReset={handleReset}
            />

            {/* Main content — flex-1 so it fills remaining width */}
            <main className="flex-1 min-w-0 pb-16 lg:pb-0 animate-up">
              ...
              <div id="color-scales" className="border-t-2 border-black">
                {/* Section header */}
              ...
              {/* ⑥ Foundation Tokens — Section 06 */}
              <div id="foundation">
                <FoundationTokens ds={designSystem} />
              </div>

              {/* ⑦ UI Components — Section 07 */}
              <div id="ui-components">
                <UIComponentsPreview ds={designSystem} />
              </div>

              {/* ⑧ Templates — Section 08 */}
              <div id="ui-templates" className="border-b-2 border-[#0a0a0a]">
